...
from agents import al_dqn
from agents import m_dqn
from agents import m_iqn

tf.disable_v2_behavior()

# flags.DEFINE_string('workdir', None, """Working directory.""")
flags.DEFINE_string('workdir', 'tmp_dqn', """Working directory.""")
flags.DEFINE_string('prefix', '', 'workdir prefix.')
flags.DEFINE_string(
    'agent_type', 'dqn', """Type of agent to train.
